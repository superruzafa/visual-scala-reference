...
\tikzset{flow left ->/.style={
    flow,
    -{Triangle[flex,left,fill=defaultpencolor, angle'=30]},
}}

\tikzset{flow right ->/.style={
    flow,
    -{Triangle[flex,right,fill=defaultpencolor, angle'=30]},
}}
...
\tikzset{subflow left ->/.style={
    subflow,
    -{Triangle[flex,left,fill=defaultpencolor, angle'=30]},
}}

\tikzset{subflow right ->/.style={
    subflow,
    -{Triangle[flex,right,fill=defaultpencolor, angle'=30]},
}}
