...
\draw [inverse flow] (a1.north) -- +(0, .5) node [element, above] {\texttt{start}};
...
\draw [inverse flow, dashed] (ai.north) arc [start angle=0, end angle=60, y radius=.5, x radius=1];
\draw [flow, dashed] (ai.north) arc [start angle=180, end angle=120, y radius=.5, x radius=1];
\draw [inverse flow, dashed] (an.north) arc [start angle=0, end angle=60, y radius=.5, x radius=1];
