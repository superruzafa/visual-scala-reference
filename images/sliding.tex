...
\bottommeasure{\texttt{m}}{a1.south west}{a2.south east}
\bottommeasure{\texttt{m}}{a3.south west}{a4.south east}
\bottommeasure{$\leq \texttt{m}$}{a5.south west}{a6.south east}
...
\topmeasure{$\leq \texttt{m}$}{In.north west}{In.north east}
