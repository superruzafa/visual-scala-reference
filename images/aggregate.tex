...
\draw [flow ->, dashed] (s2.east io 1) -| +(.25, -.5);
...
\draw [flow ->, dashed] (si.west io 1) -| +(-.25, -.5);
...
\draw [flow ->, dashed] (sn-1.west io 1) -| +(-.25, -.5);
...
\draw [<- flow, dashed] (c1.north io 1) |- +(-.25, .5);
\draw [<- flow, dashed] (c1.north io 2) |- +(.25, .5);
\draw [<- flow, dashed] (c2.north io 1) |- +(-.25, .5);
\draw [<- flow, dashed] (c2.north io 2) |- +(.25, .5);
