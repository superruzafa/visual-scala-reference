...
\pgfkeys{
    ...
    east io height/.initial=\expandafter\pgfkeysvalueof{/function/io width},
    east io sep/.initial=\expandafter\pgfkeysvalueof{/function/io sep},
    west io height/.initial=\expandafter\pgfkeysvalueof{/function/io width},
...
\pgfdeclareshape{function}{%
    ...
    \savedanchor\southwest{%
        ...
        % is height < east io height
        \pgfmathsetlength\@tempdima{\pgfkeysvalueof{/function/east io height} + \pgfkeysvalueof{/function/east io sep}}
        \pgfmathsetlength\pgf@ya{\pgfkeysvalueof{/function/east io} * \@tempdima}
        \ifdim\pgf@y<\pgf@ya \pgf@y=\pgf@ya \fi
        % is height < west io height
        \pgfmathsetlength\@tempdima{\pgfkeysvalueof{/function/west io height} + \pgfkeysvalueof{/function/west io sep}}
    ...
    \anchor{north io 1}{
        ...
        \pgfmathsetlength\@tempdima{\pgfkeysvalueof{/function/north io sep} + \pgfkeysvalueof{/function/north io width}}
    ...
    \anchor{east io 1}{
        ...
        \pgfmathsetlength\@tempdima{\pgfkeysvalueof{/function/east io sep} + \pgfkeysvalueof{/function/east io height}}
    ...
    \anchor{west io 1}{
        ...
        \advance\pgf@y by -.5\@tempdima % start of north params
        \pgfmathsetlength\@tempdima{\pgfkeysvalueof{/function/west io sep} + \pgfkeysvalueof{/function/west io height}}
        \advance\pgf@y by -.5\@tempdima
        \advance\pgf@x by \westiosheight
    }
    \anchor{west io 2}{
    ...
    \backgroundpath{%
        ...
        \foreach \i in {1,...,\pgfkeysvalueof{/function/east io}}{%
            ...
            \port{\pgfkeysvalueof{/function/east io height}}
            \pgftransformreset
            \global\advance\pgf@yc by -\pgfkeysvalueof{/function/east io height}
        ...
        \foreach \i in {1,...,\pgfkeysvalueof{/function/west io}}{%
            ...
            \pgftransformshift{\pgfqpoint{\pgf@xc}{\pgf@yc}}
            \pgftransformrotate{90}
            \port{\pgfkeysvalueof{/function/west io height}}
            \pgftransformreset
            \global\advance\pgf@yc by \pgfkeysvalueof{/function/west io height}
            \global\advance\pgf@yc by .5\@tempdima
        }
        \fi
        \pgfpathclose
