...
\draw [inverse flow] (a1.north) arc [start angle=15, end angle=100, x radius=.75, y radius=.5];
...
\draw [inverse flow, dashed] (ai.north) arc [start angle=15, end angle=80, x radius=.75, y radius=.5];
