...
\draw [flow width] (fn-1.west io 1) -| ++(-.25, 0.75) coordinate (flowy);
\draw [flow width, solid dashed solid] (flowy) -- (flowy -| fi.north io 2) coordinate (last);
\draw [flow] (last) -- (fi.north io 2);

\draw [flow width] (fi.west io 1) -| ++(-.25, 0.75) coordinate (last);
