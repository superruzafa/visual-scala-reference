...
\newcommand{\blueprint}[1]{
    \begin{scope}[on background layer]
        ...
        \coordinate (_c) at ($ (current bounding box.north west) + (-1, 1) $);
        \fill [blueprint] ($ (_a) + (-0.5, -0.5) $) rectangle ($ (_b) + (0.5, 1) $);
        ...
        \node (_d) [text=blueprint, anchor=south east, font=\Large] at (_c) {\texttt{j}};
        \node [base right=0 of _d, font=\Large] {#1};
    \end{scope}
}
