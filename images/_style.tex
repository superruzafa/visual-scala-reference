...
\tikzset{labeled element/.style 2 args={
    alias=this,
    append after command={
        \pgfextra{
            \node at (this.north) [inner sep=.5ex, font=\footnotesize, anchor=north] {\texttt{#1}};
            \node at (this.south) [inner sep=.5ex, element, anchor=south] {\texttt{#2}};
        }
    },
    draw,
    line width=\defaultpenwidth,
...
\tikzset{either left/.style={
    labeled element={Left}{#1}
}}

\tikzset{either right/.style={
    labeled element={Right}{#1},
}}
