...
\draw [exception flow, ->] (f.west) -- (y) -- (z);
...
\draw [exception flow, ->] (g.west) -- (y) -- (z);
...
\draw [inverse flow] (f.north io 1) -- (y) -- (z) -- (h.north io 1) -- +(0, .5)
...
\draw [exception flow, ->] (exg) -- (x) -- +(.25, 0) |- (y) -- (ex);

\node (f2) [function, above=4 of f] {$f$};
\draw [inverse flow] (f2.north io 1) -- +(0, .5)
...
\draw [inverse flow] (g2.north io 1) -- +(0, .5)
    node [element, above] {$x$};
