...
\topmeasure{size}{A1.north west}{A1.north east}
\topmeasure{size}{A2.north west}{A2.north east}
\topmeasure{$\leq$ size}{A3.north west}{A3.north east}

\toppointer{aj.north}{step}
\toppointer{am.north}{step}
